            ...
            <div class="flex gap-3">
                <div class="relative flex-1">
                    <input type="password" id="apiKeyInput"
                        ...
                        value="{{ $shop?->api_key ?? '' }}"
                        class="w-full rounded-lg border border-slate-200 px-3.5 py-2.5 pr-10 text-sm font-mono text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
