...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
    ...
    <div class="bg-white rounded-xl shadow-sm p-5" style="border:1px solid #DBEAFE;">
        <h3 class="text-sm font-semibold mb-0.5" style="color:#1E293B;">New vs Returning</h3>
        <p class="text-xs mb-4" style="color:#94A3B8;">Customer loyalty split</p>
        <div class="chart-wrap" style="min-height:200px;">
            <div class="chart-skeleton" id="sk-loyalty">
                <div class="sk-bar" style="width:140px;height:140px;border-radius:50%;margin:0 auto;"></div>
            </div>
            <canvas id="loyaltyChart" class="chart-canvas" height="200"></canvas>
        </div>
    </div>
...
new Chart(document.getElementById('loyaltyChart'), {
    ...
    data: {
        ...
        datasets: [{ data: [loyalty.new, loyalty.returning], backgroundColor: [GREEN, BLUE], borderWidth: 3, borderColor: '#fff', hoverOffset: 6 }]
    },
    options: {
        responsive: true,
        cutout: '62%',
...
revealChart('loyaltyChart', 'sk-loyalty');
